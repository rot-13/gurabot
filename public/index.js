...
/***/ function(module, exports, __webpack_require__) {
	...
	function sendCommand(type, data) {
		$.post('/command/' + type, data).fail(function () {
	...
	$('button[data-snd=true]').click(function () {
